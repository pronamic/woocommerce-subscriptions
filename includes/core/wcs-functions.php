...
require_once( __DIR__ . '/wcs-deprecated-functions.php' );
require_once( __DIR__ . '/wcs-compatibility-functions.php' );
require_once( __DIR__ . '/wcs-conditional-functions.php' );
require_once( __DIR__ . '/wcs-formatting-functions.php' );
require_once( __DIR__ . '/wcs-product-functions.php' );
require_once( __DIR__ . '/wcs-cart-functions.php' );
require_once( __DIR__ . '/wcs-order-functions.php' );
require_once( __DIR__ . '/wcs-time-functions.php' );
require_once( __DIR__ . '/wcs-user-functions.php' );
require_once( __DIR__ . '/wcs-helper-functions.php' );
require_once( __DIR__ . '/wcs-renewal-functions.php' );
require_once( __DIR__ . '/wcs-resubscribe-functions.php' );
require_once( __DIR__ . '/wcs-switch-functions.php' );
require_once( __DIR__ . '/wcs-limit-functions.php' );

if ( is_admin() ) {
	require_once( __DIR__ . '/admin/wcs-admin-functions.php' );
}
